                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @T_A_Tl\
                                  \n\n--------بـدء تتبـع سجـل يمنثون  𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉𖤊--------\
                        ...
                        command = "git log -n 5 --name-only --pretty=format:'' | grep -v '^$' | sort -u | head -n 5"
                        ...
                        link = "[YamenThon (https://t.me/T_A_Tl)"
                        text = (
                            "**✘ تقـريـر إشعـار يمنثون  𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉𖤊 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار يمنثون 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉𖤊 ✘**\n\n "
                        link = "[YamenThon (https://t.me/T_A_Tl)"
