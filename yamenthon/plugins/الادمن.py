...
async def promote(event):
    ...
    await zzevent.edit(f"**    ⃟⁞⃟⟢ ╎المستخـدم** [{user.first_name}](tg://user?id={user.id}) \n**    ⃟⁞⃟⟢ ╎تم رفعـه مشـرفـاً .. بنجـاح✓**")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            f"#رفــع_مشــرف\
            \n**    ⃟⁞⃟⟢ ╎الشخـص :** [{user.first_name}](tg://user?id={user.id})\
            \n**    ⃟⁞⃟⟢ ╎المجمــوعــه :** {get_display_name(await event.get_chat())} (`{event.chat_id}`)",
        )
...
async def promote(event):
    ...
    try:
        ...
        return await zzevent.edit(NO_PERM)
    await zzevent.edit(f"**    ⃟⁞⃟⟢ ╎المستخـدم** [{user.first_name}](tg://user?id={user.id}) \n**    ⃟⁞⃟⟢ ╎تم رفعـه مشـرفـاً بكل الصلاحيـات ✓**")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            f"#رفــع_مشــرف\
...
async def demote(event):
    ...
    try:
        ...
        return await zzevent.edit(NO_PERM)
    await zzevent.edit("**    ⃟⁞⃟⟢ ╎المستخـدم** [{user.first_name}](tg://user?id={user.id}) \n**    ⃟⁞⃟⟢ ╎تم تنـزيلـه مشـرف .. بنجـاح✓**")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            f"#تنـزيــل_مشــرف\
    ...
    if BOTLOG:
        if reason:
            await event.client.send_message(
                BOTLOG_CHATID,
                f"#الحظــࢪ\
                \n**    ⃟⁞⃟⟢ ╎المحظـور :** [{user.first_name}](tg://user?id={user.id})\
                \n**    ⃟⁞⃟⟢ ╎الدردشــه :** {get_display_name(await event.get_chat())}(`{event.chat_id}`)\
                \n**    ⃟⁞⃟⟢ ╎السـبب :** {reason}",
            )
        else:
            await event.client.send_message(
    ...
    try:
        ...
        if BOTLOG:
            await event.client.send_message(
                ...
                f"**    ⃟⁞⃟⟢ ╎الدردشــه :** {get_display_name(await event.get_chat())}(`{event.chat_id}`)",
            )
...
async def kick(event):
    ...
    if reason:
        await zedevent.edit(
            f"**    ⃟⁞⃟⟢ ╎تم طــࢪد**. [{user.first_name}](tg://user?id={user.id})  **بنجــاح ✓**\n\n**    ⃟⁞⃟⟢ ╎السـبب :** {reason}"
        )
    else:
        await zedevent.edit(f"**    ⃟⁞⃟⟢ ╎تم طــࢪد**. [{user.first_name}](tg://user?id={user.id})  **بنجــاح ✓**")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            "#الـطــࢪد\n"
            f"**    ⃟⁞⃟⟢ ╎الشخـص**: [{user.first_name}](tg://user?id={user.id})\n"
            f"**    ⃟⁞⃟⟢ ╎الدردشــه** : {get_display_name(await event.get_chat())}(`{event.chat_id}`)\n",
        )
...
async def pin(event):
    ...
    await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تم تثبيـت الرسـالـه .. بنجــاح ✓**", 3)
    ...
    if BOTLOG and not event.is_private:
        await event.client.send_message(
            BOTLOG_CHATID,
            f"#تثبيــت_رســالـه\
                \n**    ⃟⁞⃟⟢ ╎تم تثبيــت رســالـه فـي المجمـوعـة**\
                \n**    ⃟⁞⃟⟢ ╎الدردشــه :** {get_display_name(await event.get_chat())}(`{event.chat_id}`)\
                \n**    ⃟⁞⃟⟢ ╎الإشعـار :** {is_silent}",
        )
...
async def unpin(event):
    ...
    try:
        ...
        return await edit_delete(event, f"`{e}`", 5)
    await edit_delete(event, "**    ⃟⁞⃟⟢ ╎تم الغـاء تثبيـت الرسـالـه/الرسـائـل .. بنجــاح ✓**", 3)
    sudo_users = _sudousers_list()
    if event.sender_id in sudo_users:
        with contextlib.suppress(BadRequestError):
            await event.delete()
    if BOTLOG and not event.is_private:
        await event.client.send_message(
            ...
            f"#الغــاء_تثبيــت_رســالـه\
                \n**    ⃟⁞⃟⟢ ╎تم الغــاء تثبيــت رســالـه فـي الدردشــه**\
                \n**    ⃟⁞⃟⟢ ╎الدردشــه** : {get_display_name(await event.get_chat())}(`{event.chat_id}`)",
        )
