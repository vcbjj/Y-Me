...
RORDR = gvarstatus("R_ORDR") or "الاوامر"
RPORDR = gvarstatus("R_PORDR") or "الاوامر"
...
#لـوحــة الاوامــر - حقــوق يـــمنثون
...
async def rep_handler(event):
    ...
    if query.startswith("الاوامر") and event.query.user_id == zedub.uid:
        ...
        result = builder.article(title="zedub",text=Tiba,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
@zedub.zed_cmd(pattern="ytopjxxiff854dffi(?: |$)(.*)")
...
async def rep(event):
    await edit_or_reply(event, f"[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمــة الاوامــر العامــه](t.me/YamenThon) 𓆪\n⋆┄─┄─┄─┄┄─┄《》─┄─┄─┄┄⋆\n**⌔ مـرحبـاً عـزيـزي {mention}\n⌔  اضغـط ع الامـر لـ النسـخ**\n**⌔ لا تنسى وضـع نقطه (.) بداية كل امـر :**\n\n"
...
" `.م8`   **➪ اوامــر الفــارات** ⚙️  \n"
" `.م9`   **➪ اوامــر الـخدمــات** 🛠️  \n"
...
" `.م23`  **➪ اوامــر المطــور المســاعـد** 🛡️ \n"
" `.م24`  **➪ اوامــر الـذاتيــة** 🔒 \n"
"`.م25`  **➪ اوامــر الخطوط** ✒️\n"
"`.م26`  **➪ اوامــر هاك كود ترمكس** 🌋\n"
"`.م27`  **➪ اوامــر الذكـاء الاصطنـاعـي** 🌟\n"
"`.م28`  **➪ اوامــر منوعــه جديـدة** 🥏\n\n"
"ارسل امر (`.مساعده`) لعرض الاوامر داخل الازارر ♡\n"
"♤⋆┄┄─┄─┄─┄─┄┄⋆┄─┄─┄─┄┄─┄┄⋆♤")
...
"`.بريد` يقوم بعمل بريد افتراضي تستطيع استخدامه في التسجيل في بعض المواقع🌐\n\n"
...
@zedub.on(events.NewMessage(pattern=r"^(المطور|الاسطوره|عاشق|الاسطوره عاشق الصمت|عاشق الصمت)$"))
async def rep(event):
    ...
    𓂄𓆩⧛ َِ𝘼َِ𝙎َِ𝙏َِ𝙃َِ𝙀َِ𝙀َِ𝙏َِ𝙊َِ ⧚𓆪𓂂
    
    ✧ **مـطـور السـورس** ✧
    ✧ **الاسـطـورة عـاشـق الصـمـت** ✧
    
    ════『 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 』═══
    
    𓆩 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 𓆪 ➥ [𝚈𝙰𝙼𝙴𝙽 𝚃𝙷𝙾𝙽](t.me/YamenThon)
    𓆩 𝙈𝘼𝙎𝙏𝙀𝙍 𓆪 ➥ [𝙰𝚂𝙷𝙴𝚀 𝙰𝙻𝚂𝙰𝙼𝚃](t.me/T_A_Tl)
    
    ✧╬═══❖ 𝐘𝐀𝐌𝐄𝐍 𝐓𝐇𝐎𝐍 ❖═══╬✧
    """)
#الكـالبـاك ابديـت - يـــمنثون
@zedub.tgbot.on(CallbackQuery(data=re.compile("bbaqir")))
@check_owner
async def on_plug_in_callback_query_handler(event):
    buttons = [[Button.inline("❶", data="baqir1"), Button.inline("❷", data="baqir2"), Button.inline("❸", data="baqir3"), Button.inline("❹", data="baqir4"),],[Button.inline("❺", data="baqir5"), Button.inline("❻", data="baqir6"), Button.inline("❼", data="baqir7"), Button.inline("❽", data="baqir8"),],[Button.inline("❾", data="baqir9"), Button.inline("❿", data="baqir10"), Button.inline("⓫", data="baqir11"),],[Button.inline("⓬", data="baqir12"), Button.inline("⓭", data="baqir13"), Button.inline("⓮", data="baqir14"), Button.inline("⓯", data="baqir15"),],[Button.inline("⓰", data="baqir16"), Button.inline("⓱", data="baqir17"),],[Button.inline("⓲", data="baqir18"), Button.inline("⓳", data="baqir19"), Button.inline("⓴", data="baqir20"),]]
    await event.edit(Tiba, buttons=buttons)

@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir1")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    buttons = [[Button.inline("رجــوع", data="bbaqir")]]
    orden1 = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البحـث والتحميــل](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.بحث` + اسـم الاغنيـه\n**لـ تحميـل الاغـاني مـن يوتيـوب بدقه خفيفـه وتحميـل اسـرع**\n\n⪼ `.يوت` + كلمـه او بالـرد ع رابـط\n**لـ تحميـل الصوت والفيديـو بعـدة صيـغ مـن اليـوتيـوب بواسطـة لوحـه انلايـن شفافـه**\n\n⪼ `.فيديو` + اسـم المقطـع\n**لـ تحميـل مقـاطع الفيديـو مـن يوتيـوب**\n\n⪼ `.تحميل صوت` + رابـط\n**لـ تحميـل المقـاطع الصـوتيه من يوتيـوب عبر الرابـط**\n\n⪼ `.تحميل فيديو` + رابـط\n**لـ تحميـل مقـاطع الفيـديـو من يوتيـوب عبر الرابـط**\n\n⪼ `.يوتيوب`+ كلمـه\n**لـ البحث عـن روابـط بالكلمـه ع يوتيـوب **\n\n⪼ `.انستا` + رابـط\n**لـ تحميـل الصـور ومقـاطع الفيديـو مـن الانستجـرام**\n\n⪼ `.صور` + كلمـه\n**لـ البحث وتحميـل الصـور من جوجـل بدقـه HD**\n\n⪼ `.ملصقات` + كلمـه\n**لـ البحث عن حـزم ملصقـات على تيليجـرام..**\n\n⪼ `.متحركه` + كلمـه\n**لـ البحث عن صـور متحركـه من جـوجـل..**\n\n⪼ `.تيك` + رابـط او بالـرد ع رابـط\n**لـ تحميـل مقاطـع الفيديـو من تيك توك**\n\n⪼ `.لايكي` + رابـط\n**لـ تحميـل مقاطـع الفيديـو من لايكـي**\n\n⪼ `.فيس` + رابـط او `.فيس` بالـرد ع رابـط\n**لـ تحميـل مقاطـع الفيديـو مـن فيس بـوك**\n\n⪼ `.تويتر` + رابـط\n**لـ تحميـل مقاطـع الفيديـو من تويتـر**\n\n⪼ `.بنترست` + رابـط\n**لـ تحميـل مقاطـع الفيديـو من بنتـرست**\n\n⪼ `.سناب` + رابـط\n**.سناب + رابـط لـ تحميـل مقاطـع الفيديـو من سناب شـات**\n\n⪼ `.ساوند` + رابـط\n**.ساوند + رابـط او بالـرد ع رابـط لـ تحميـل الاغـاني مـن سـاونـد كلـود عـبر الرابـط**\n\n\n**• اوامــر البحث الذكيـه الخاصـه بـ تيليجـرام 🔎 :**\n**خاصه وحصرية ع سـورس يـــمنثون فقـط**\n\n⪼ `.تلي` + كلمة\n** امـر بحث خاص داخل تيليجـرام  لـ البحث عن قنوات + مجموعات بالكلمـه يعطيك قائمة بالقنوات والمجموعات الموجوده ع التلي**\n\n⪼ `.كلمه` + الكلمة\n** امـر بحث خاص داخل مجموعات تيليجـرام  لـ البحث عن كلمة محدده داخل المجموعة يعطيك قائمة بروابط الرسائل المحتويه ع الكلمة داخل المجموعة**"
    try:
        await event.edit(orden1, buttons=buttons, link_preview=False)
    except Exception:
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir2")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/YamenThon) .\n\n⪼ `.اعاده تشغيل`\n**لـ لتـرسيت واعـادة تشغيـل البـوت**\n\n⪼ `.ايقاف البوت`\n**لـ ايقـاف البـوت عـن العمـل والغـاء التنصـيب**\n\n⪼ `.تحديث`\n**لـ البحـث عـن تحديثـات وتحديث البـوت**\n\n⪼ `.تحديث الان`\n**لـ التحـديث الاولـي لـ البـوت لـ التنصيـب الثـانوي**\n\n⪼ `.تحديث البوت`\n**لـ التحـديث الثـانوي لـ البـوت لـ التنصيـب الاولـي والثـانوي**\n\n⪼ `.فحص`\n**لـ فحص قاعدة البيانات وعـرض اصـدار السورس ولغة بايثـون ومكتبة تيليثون**\n\n⪼ `.سليب` او `.سليب_ميديا`\n**لـ جعل البـوت في وضع النـوم او الإسبات ويتم ايقافه عند ارسالك لـ اي رسالة**\n\n⪼ `.الانترنت` او `.الانترنت صورة`\n**لـ عرض سرعة الانتـرنت (الرفـع & التحميـل) في سيرفـر البوت الخاص بك**\n\n⪼ `.المساعد`\n**لـ عـرض قائمـة اوامـر المطـور المسـاعد**\n\n⪼ `.الاذاعه`\n**لـ عـرض اوامـر الاذاعـه والتوجيـه**\n\n⪼ `.النظام`\n**لـ لعـرض معلومـات نظـام البـوت الخـاص بك**\n\n⪼ `.السرعه`\n**لـ قياس سرعة الرفع والتحميل في سيرفر البوت الخاص بك**\n\n⪼ `.فرمته`\n**لـ حذف المجلدات والملفات والعمليات المخزنه مؤقتـاً في سيرفر البوت الخاص بك**\n\n⪼ `.فاراتي`\n**لـ عـرض جميـع فارات تنصيبك**\n\n⪼ `.تاريخ التنصيب`\n**لـ عـرض تاريـخ بـدء تنصيبك على سـورس يـــمنثون**\n\n**•❐• لعـرض اصـدار السـورس ارسـل** `.سورس`\n**•❐• لعـرض قنـوات السـورس ارسـل** `.يـــمنثون`\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    try:
        await event.edit(text, buttons=roger, link_preview=False)
    except Exception:
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir3")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الوقتـــي ⌚️](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.الاسم تلقائي`\n\n⪼ `.البايو تلقائي`\n\n⪼ `.البروفايل تلقائي` \n\n⪼ `.انهاء الاسم` | `.انهاء البايو` | `.انهاء البروفايل`\n\n⪼ `.اوامر الوقتي`\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    try:
        await event.edit(text, buttons=roger, link_preview=False)
    except Exception:
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir4")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه¹](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.البوتات`\n\n⪼ `.قفل البوتات` | `.فتح البوتات`\n\n⪼ `.قفل الدردشه` | `.فتح الدردشه`\n\n⪼ `.قفل الصور` | `.فتح الصور`\n\n⪼ `.قفل الملصقات` | `.فتح الملصقات`\n\n⪼ `.قفل المتحركه` | `.فتح المتحركه`\n\n⪼ `.قفل الاضافه` | `.فتح الاضافه`  \n\n⪼ `.قفل الدخول` | `.فتح الدخول `\n\n⪼ `.قفل الميديا` | `.فتح الميديا `\n\n⪼ `.قفل تعديل الميديا` | `.فتح تعديل الميديا `\n\n⪼ `.قفل الفشار` | `.فتح الفشار`\n\n⪼ `.قفل الفارسيه` | `.فتح الفارسيه`\n\n⪼ `.قفل الروابط` | `.فتح الروابط`\n\n⪼`.قفل المعرفات` | `.فتح المعرفات`\n\n⪼ `.قفل التوجيه` | `.فتح التوجيه`\n\n⪼ `.قفل الانلاين` | `.فتح الانلاين`\n\n⪼ `.قفل المميز` | `.فتح المميز`\n\n⪼ `.قفل التفليش` | `.فتح التفليش`\n\n⪼ `.قفل الكل` | `.فتح الكل`\n\n⪼ `.قيد`   لتقييـد المحتـوى\n\n⪼ `.الاعدادات`\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    try:
        await event.edit(text, buttons=roger, link_preview=False)
    except Exception:
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir5")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.الرابط`\n\n⪼`.رسائلي` | `.رسائله` \n\n⪼ `.حذف رسائلي`\n\n⪼ `.غادر`\n\n⪼ `.رفع مشرف`\n\n⪼ `.تنزيل مشرف`\n\n⪼ `.رفع مالك`\n\n⪼ `.الاعدادات`\n\n⪼ `.تاك` | `.all` \n\n⪼ `ايقاف التاك` \n\n\n⪼ `.احصائياتي`\n\n⪼ `.كروباتي الكل` | `.كروباتي ادمن` | `.كروباتي مالك`\n\n⪼ `.قنواتي الكل` | `.قنواتي ادمن` | `.قنواتي مالك`\n\n⪼ `.الاعضاء` | `المشرفين` \n\n⪼ `.البوتات`\n\n⪼ `.المحذوفين`\n\n⪼ `.مسح المحظورين`\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    ...
    try:
        ...
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir6")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الحســاب 🚹](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.ضع اسم` | `.ضع بايو` | `.ضع يوزر` | `.ضع صورة`\n**.الامـر بالـرد او + نـص لـ تغييـر اسـم او بايـو او صـورة حسابـك**\n\n⪼ `.ايدي` او `.ا`\n**.ايدي بالـرد او + معـرف/ايـدي الشخص لـ عـرض معلومـات الشخـص**\n\n⪼ `.الايدي`\n**.الايدي بالـرد لـ جلـب ايـدي الشخـص والمجمـوعـة**\n\n⪼ `.حزمة`\n**.صورته بالـرد / .صورته الكل بالـرد لـ جـلب جميـع بروفـايلات الشخـص**\n\n⪼ `.اسمي` | `.اسمه`\n**.اسمه بالـرد لـ جـلب اسـم الشخـص**\n\n⪼ `.الاسماء`\n**.الاسماء بالـرد / .الاسماء + معـرف او ايدي الشخـص لـ جـلب قائمـة بسجـل اسمـاء حسـاب الشخـص**\n\n⪼ `.المعرفات`\n**.المعرفات بالـرد / .المعرفات + معـرف او ايدي الشخـص لـ جـلب قائمـة بسجـل معـرفـات حسـاب الشخـص**\n\n⪼ `.تخزين الخاص تفعيل`\n**الامـر + تفعيل او تعطيل لـ تخـزين جميـع رسـائل الخـاص بـ كـروب التخـزين**\n\n⪼ `.تخزين الكروبات تفعيل`\n**الامـر + تفعيل او تعطيل لـ تخـزين جميـع تاكـات المجمـوعـةات بـ كـروب التخـزين**\n\n\n**- اوامــر حمـايــة الخــاص🛡 :**\n\n⪼ `.الحمايه تفعيل`\n**لـ تفعيـل حمايـة الخـاص لـ حسـابك**\n\n⪼ `.الحمايه تعطيل`\n**لـ تعطيـل حمايـة الخـاص لـ حسـابك**\n\n⪼ `.قبول`\n**لـ السمـاح لـ الشخـص بـ ارسـال رسـائل الخـاص اثنـاء تفعيـل حمـاية الخـاص بحسـابك بـدون تحـذير**\n\n⪼ `.رفض`\n**لـ رفـض الشخـص من ارسـال رسـائل الخـاص اثنـاء تفعيـل حمـاية الخـاص بحسـابك**\n\n⪼ `.مرفوض`\n**لـ حظـر الشخـص من الخـاص دون تحـذير**\n\n⪼ `.المقبولين`\n**لـ عـرض قائمـة بالاشخـاص المقبـولين**\n\n\n**- اوامــر الحظــر - الكتــم - الطــرد 🔕 :**\n\n⪼ `.حظر`  /  `.الغاء حظر`\n\n⪼ `.كتم`  /  `.الغاء كتم`\n\n⪼ `.طرد`\n\n⪼ `.ح عام`\n\n⪼ `.الغاء ح عام`\n\n⪼ `.ك عام`\n\n⪼ `.الغاء ك عام`\n\n⪼ `.ط عام`\n\n⪼ `.الحاظرهم`\n**لـ جلب قائمـه بالاشخاص المحظورين خاص**\n\n⪼ `.رسائلي` | `.رسائله`\n**لـ عـرض عـدد رسائلك او رسائل شخص في المجمـوعـة**\n\n⪼ `.حذف رسائلي` + عـدد\n**لـ حـذف رسائلك من المجمـوعـة**\n\n⪼ `.احذف` + معـرف\n**لـ حذف دردشـة مع شخص من الخاص**"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    try:
        await event.edit(text, buttons=roger, link_preview=False)
    except Exception:
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir7")))
@check_owner
async def rep_handler(event):
    baqir = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الاوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تحـويـل الصيــغ 💡🎞](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.ملصق`\n\n⪼ `.حزمه`\n\n⪼ `.حزمة`\n\n⪼ `.معلومات الملصق`\n\n⪼ `.ملصقات`\n\n⪼ `.لملصق`\n\n⪼ `.لصوره`\n\n⪼ `.لفيد`\n\n⪼ `.دائري`\n\n⪼ `.لمتحركة`\n\n⪼ `.حول بصمه`\n\n⪼ `.حول صوت`\n\n⪼ `.لمتحركه`\n\n⪼ `.لمتحرك`\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    try:
        await event.edit(text, buttons=roger, link_preview=False)
    except Exception:
        await event.answer(baqir, cache_time=0, alert=True)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir8")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الـفــارات 🎛](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**「❖╎قائـمه اوامر تغييـر فـارات الصـور بأمـر واحـد فقـط - لـ اول مـره ع سـورس تليثـون يوزر بـوت 🦾 :** \n\n⪼ `.اضف صورة الحماية` بالـرد ع صـورة او ميديـا\n\n⪼ `.اضف صورة الفحص` بالـرد ع صـورة او ميديـا\n⪼ قنـاة كلايـش الفحـص @YamenThon_cklaish\n\n⪼ `.اضف صورة الوقتي` بالـرد ع صـورة او ميديـا\n\n⪼ `.اضف صورة الاوامر` بالـرد ع صـورة او ميديـا\n\n⪼ `.اضف صورة السورس` بالـرد ع صـورة او ميديـا\n\n⪼ `.اضف صورة الكتم` بالـرد ع صـورة او ميديـا\n\n⪼ `.اضف صورة البوت` بالـرد ع صـورة او ميديـا لـ اضـافة صـورة ستـارت للبـوت\n\n⪼ `.اوامر الفارات` لعـرض بقيـة اوامـر الفـارات\n\n\n**「❖╎قائـمه اوامر تغييـر كليشـة الايـدي :** \n\n⪼ `.اضف ايموجي الايدي` بالـرد ع الرمـز او الايموجـي\n\n⪼ `.اضف عنوان الايدي` بالـرد ع نـص العنـوان\n\n⪼ `.اضف خط الايدي` بالـرد ع الخـط او المستقيـم\n\n⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة @YamenThon\n\n\n**「❖╎قائـمه اوامر تغييـر بقيـة الفـارات بأمـر واحـد فقـط :** \n\n⪼ `.اضف كليشة الحماية` بالـرد ع الكليشـة\n⪼ قنـاة كلايـش حمايـة الخـاص @YamenThon\n\n⪼ `.اضف كليشة الفحص` بالـرد ع الكليشـة\n⪼ قنـاة كلايـش الفحـص @YamenThon\n\n⪼ `.اضف كليشة الحظر` بالـرد ع الكليشـة\n\n⪼ `.اضف كليشة البوت` بالـرد ع الكليشـة لـ اضـافة كليشـة ستـارت\n\n⪼ `.اضف رمز الوقتي` بالـرد ع رمـز\n\n⪼ `.اضف زخرفة الوقتي` بالـرد ع ارقـام الزغـرفه\n\n⪼ `.اضف البايو الوقتي` بالـرد ع البـايـو\n\n⪼ `.اضف اسم المستخدم` بالـرد ع اسـم\n\n⪼ `.اضف كروب الرسائل` بالـرد ع ايدي الكـروب\n\n⪼ `.اضف كروب السجل` بالـرد ع ايدي الكـروب\n\n⪼ `.اضف ايديي` بالـرد ع ايدي حسـابك\n\n⪼ `.اضف نقطة الاوامر` بالـرد ع الـرمز الجديـد\n\n⪼ `.اضف نوم الترحيب` بالـرد ع رقـم الساعة لبداية نوم الترحيب المؤقت\n\n⪼ `.اضف رسائل الحماية` بالـرد ع رقـم لعدد رسائل تحذيـرات حماية الخاص\n\n\n⪼ `.جلب` + اسـم الفـار\n\n⪼ `.حذف فار` + اسـم الفـار\n\n⪼ `.رفع مطور` بالـرد ع الشخـص لرفعـه مطـور تحكـم كامـل بالاوامـر\n\n⪼ `.حذف فار المطورين`\n\n**「❖╎قائـمه اوامر تغييـر المنطقـة الزمنيـة للوقـت 🌐:** \n\n⪼ `.وقت اليمن` \n\n⪼ `.وقت مصر` \n\n⪼ `.وقت الامارات` \n\n⪼ `.وقت ايران` \n\n⪼ `.وقت الجزائر` \n\n⪼ `.وقت المغرب` \n\n⪼ `.وقت تركيا` \n\n⪼ `.وقت العراق`"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir9")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الـخدمــات العـامــه 🎡](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.مساعده`\n\n⪼ `.اوامر الفارات`\n\n⪼ `.اوامر السوبر`\n\n⪼ `.اوامر النشر`\n\n⪼ `.الترحيب`\n\n⪼ `.الردود`\n\n⪼ `.الاذاعه`\n\n⪼ `.التكرار`\n\n⪼ `.المساعد`\n\n⪼ `.الطقس`\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir10")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳 ](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.بلاي` \n**- العــاب الانـلايـن لســورس يـــمنثون 🕹**\n\n⪼ `.كت`\n**- اسئلـة كـت تـويت ⁉️**\n\n⪼ `.احكام`\n**- لعبــة احكــام الشهيــرة ⚖👩🏻‍⚖**\n\n⪼ `.عقاب`\n**- لعبــة عقــاب ⛓**\n\n⪼ `.اكس او`\n**- لعبــة اكـس او 🧩**\n\n⪼ `.نرد`\n**- لعبــة رمـي النــرد 🎲**\n\n⪼ `.سهم`\n**- لعبــة رمـي السهــم 🎯**\n\n⪼ `.سله`\n**- لعبــة كــرة السلــة 🏀**\n\n⪼ `.كرة`\n**- لعبــة كــرة القــدم ⚽️**\n\n⪼ `.حظ`\n**- لعبــة الحــظ 🎰**\n\n⪼ `.خيرني`\n**- لعبــة لـو خيـروك بالصـور ⁉️🌉**\n\n⪼ `.تويت`\n**- لعبــة كـت تـويت بالصـور ⁉️🌁**\n\n\n**- سيتـم اضـافــة المـزيــد من الالعــاب بالتحديثــات الجــايـه 🎭**"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir11")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمــة اوامــر التسـليــه 🏂](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.تسليه1`\n⪼ `.تسليه2`\n⪼ `.تسليه3`\n⪼ `.تسليه4`\n⪼ `.تسليه5`\n⪼ `.تسليه6`\n⪼ `.تسليه7`\n⪼ `.تسليه8`\n⪼ `.تسليه9`\n⪼ `.تسليه10`\n`.تهكير`\n\n**「❖╎قائـمه اوامــر التسـليـه الجـديـده حقـوق سـورس يـــمنثون:**\n\n⪼ `.حيوان` بالـرد\n\n⪼ `.زاحف` بالـرد\n\n⪼ `.مشهور` بالـرد\n\n⪼ `.مشهوره` بالـرد\n\n⪼ `.التحشيش`\n\n⪼ `.معاني` + اسـم\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir12")))
@check_owner
async def repthon_handler(zedub):
    text = "**「❖╎قائمــة اوامــر التحشيـش 🎃 :**\n**- اضغـط ع الامـر للنسـخ ثـم قـم بالـرد ع الشخـص**\n\n⪼ `.اوصف`  /  `.هينه` \n⪼ `.نسبه الحب`\n⪼ `.نسبه الانوثه`\n⪼ `.نسبه الغباء`\n⪼ `.نسبه النجاح`\n⪼ `.نسبه الانحراف`\n⪼ `.نسبه المثليه`\n⪼ `.نسبه الكراهيه`\n\n⪼ `.رفع تاج`  /  `.رفع بقلبي`\n⪼ `.رفع صاك`  /  `.رفع صاكه`\n⪼ `.رفع حات`  /  `.رفع حاته`\n⪼ `.رفع ورع`  /  `.رفع مزه`\n⪼ `.رفع مرتي`  /  `.رفع خطيبتي` \n⪼ `.رفع مطي`  /  `.رفع حمار`  /  `.رفع جلب`\n⪼ `.رفع حيوان`  /  `.رفع خروف` \n⪼ `.رفع بزون`  /  `.رفع جريذي`\n⪼ `.رفع فرخ`  /  `.رفع زباله`\n⪼ `.زاحف`  /  `.رفع جلب`\n⪼ `.رفع مرتبط`  /  `.رفع مرتبطه`\n⪼ `.رفع حبيبي`\n⪼ `.رفع مدير`  /  `.رفع منشئ`"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir13")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🌌](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.حالات واتس`\n**- اكثـر مـن 2000 فيديـو حالات واتسـاب قصيـرة 🎬**\n\n⪼`.ستوري انمي`\n**- مقاطـع ستوريـات انمـي قصيـرة 🎞**\n\n⪼ `.ادت`\n**- مقاطـع ادت منـوعـة 🎥**\n\n⪼ `.رياكشن`\n**- مقاطـع رياكشـن ترفيهيــه 📺**\n\n⪼ `.ميمز`\n**- بصمـات ميمـز تحشيـش 🎃**\n\n⪼ `.غنيلي`\n**- مقاطـع اغـانـي قصيـره 🎶**\n\n⪼ `.شعر`\n**- مقاطـع صـوت شعـريـه 🎙**\n\n⪼ `.رقيه`\n**- رقيـه شرعيـة لعـدة مشائـخ 🕋**\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir14")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.ولد انمي`\n**- اكثـر مـن 2500 آفتـار آنمـي شبـاب 🙋🏻‍♂🎆**\n\n⪼`.بنت انمي`\n**- اكثـر مـن 1800 آفتـار آنمـي بنـات 🙋🏻‍♀🎆**\n\n⪼ `.رمادي`\n**- آفتـارات شبـاب رمـاديـه 🏂🏙**\n\n⪼ `.رماديه`\n**- آفتـارات بنـات رمـاديـه ⛹🏻‍♀🌁**\n\n⪼ `.بيست`\n**- آفتـارات بيست تطقيـم بنـات 👯‍♀🏖**\n\n⪼ `.حب`\n**- آفتـارات بيست تطقيـم حب ♥️🧚‍♂🧚‍♀**\n\n⪼ `.بنات`\n**- اكثـر مـن 2500 آفتـارات بنـات تمبلـر 💅🎆**\n\n⪼ `.ري اكشن`\n**- صـور رياكشـن تحشيـش 🎃😹**\n\n⪼ `.معلومه`\n**- صـوره ومعلومـه معلومـات عـامـه 🗺**\n\n\n 𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir15")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**✾╎اولاً قـائمـة اوامـر تشيكـر صيـد معـرفات تيليجـرام :** \n\n`.النوع`\n**⪼ لـ عـرض الانـوع التي يمكـن صيدهـا مع الامثـله**\n`.صيد` + النـوع\n**⪼ لـ صيـد يـوزرات عشوائيـه على حسب النـوع**\n`.حالة الصيد`\n**⪼ لـ معرفـة حالـة تقـدم عمليـة الصيـد**\n`.صيد ايقاف`\n**⪼ لـ إيقـاف عمليـة الصيـد الجاريـه**\n\n\n**✾╎ثانياً قـائمـة اوامـر تشيكـر تثبيت معـرفات تيليجـرام :** \n\n`.تثبيت_قناة` + اليوزر\n**⪼ لـ تثبيت اليـوزر بقنـاة معينـه اذا اصبح متاحـاً يتم اخـذه**\n`.تثبيت_حساب` + اليوزر\n**⪼ لـ تثبيت اليـوزر بحسـابك مباشـرة اذا اصبح متاحـاً يتم اخـذه**\n`.تثبيت_بوت` + اليوزر\n**⪼ لـ تثبيت اليـوزر في بـوت فـاذر اذا اصبح متاحـاً يتم اخـذه**\n\n`.حالة تثبيت_القناة`\n**⪼ لـ معرفـة حالـة تقـدم التثبيت التلقـائـي على القنـاة**\n`.حالة تثبيت_الحساب`\n**⪼ لـ معرفـة حالـة تقـدم التثبيت التلقـائـي على حسابـك**\n`.حالة تثبيت_البوت`\n**⪼ لـ معرفـة حالـة تقـدم التثبيت التلقـائـي على بـوت فـاذر**\n\n`.ايقاف تثبيت_القناة`\n**⪼ لـ إيقـاف عمليـة تثبيت_القناة التلقـائـي**\n`.ايقاف تثبيت_الحساب`\n**⪼ لـ إيقـاف عمليـة تثبيت_الحساب التلقـائـي**\n`.ايقاف تثبيت_البوت`\n**⪼ لـ إيقـاف عمليـة تثبيت_البوت التلقـائـي**\n\n\n**- ملاحظـات مهمـه قبـل استخـدام اوامـر الصيـد والتثبيت :**\n**⪼** تأكد من ان حسابك يوجد فيه مساحه لانشاء قناة عامة (قناة بمعرف)\n**⪼** اذا كان لا يوجد مساحه لانشاء قناة عامة قم بارسال يوزر اي قناة من قنوات حسابك وبالرد ع يوزرها ارسل احد اوامر الصيد\n**⪼** لا تقم بـ ايقاف الصيد حتى ولو استمر الصيد ايام\n**⪼** تحلى بالصبر وكرر محاولات الصيد حتى تصيد يوزر\n**⪼** كل نوع من اليوزرات يختلف عن الاخر من حيث نسبة الصيد\n**⪼ التثبيت هو تثبيت يوزر محدد حتى ماينسرق منك عندما يصير متاح**"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"ahmad16")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**「❖╎قـائمـة اوامـر النشـر التلقـائي الخاص بسـورس يـــمنثون 🦾 :**\n\n**- هي عبارة عن فكـرة تسمح لـ البوت الموجود بحسابك بنشـر منشورات تلقائيـه بقناتك من قناة انت تحددهـا** \n\n\n⪼`.تلقائي`\n**⪼ الامـر + (معـرف/ايـدي/رابـط) القنـاة المـراد النشـر التلقـائي منهـا .. استخـدم الامـر داخـل قناتك✓**\n\n⪼ `.ستوب`\n**⪼ الامـر + (معـرف/ايـدي/رابـط) القنـاة المـراد ايقـاف النشـر التلقـائي منهـا .. استخـدم الامـر داخـل قناتك ✓**\n\n\n**- ملاحظـه 🧧:**\n**- الاوامـر صـارت تدعـم القنـوات الخاصه ايضـاً والمعـرفات والروابـط ايضاً الى جـانب الايـدي .. ع عكس بقية السورسات 🏂🎗**\n**🛃 سيتـم اضـافة المزيـد من اوامــر النشـر التلقـائي بالتحديثـات الجـايه**"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir17")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**「❖╎قـائمـة اوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس يـــمنثون 🦾 :** \n\n⪼ `.المليار`\n**⪼ لـ تجميـع النقـاط مـن بـوت المليـار ( @EEOBot ) .. تلقـائيـاً ✓**\n\n⪼ `.العرب`\n**⪼ لـ تجميـع النقـاط مـن بـوت العـرب ( @xnsex21bot ) .. تلقـائيـاً ✓**\n\n⪼ `.دعمكم`\n**⪼ لـ تجميـع النقـاط مـن بـوت دعمكـم ( @DamKombot ) .. تلقـائيـاً ✓**\n\n⪼ `.الجوكر`\n**⪼ لـ تجميـع النقـاط مـن بـوت الجوكـر ( @A_MAN9300BOT ) .. تلقـائيـاً ✓**\n\n⪼ `.الجنرال`\n**⪼ لـ تجميـع النقـاط مـن بـوت الجنــرال ( @MARKTEBOT ) .. تلقـائيـاً ✓**\n\n⪼ `.المليون`\n**⪼ لـ تجميـع النقـاط مـن بـوت المليــون ( @qweqwe1919bot ) .. تلقـائيـاً ✓**\n\n⪼ `.سمسم`\n**⪼ لـ تجميـع النقـاط مـن بـوت سمـسـم ( @SMSMWAbot ) .. تلقـائيـاً ✓**\n\n⪼ `.تناهيد`\n**⪼ لـ تجميـع النقـاط مـن بـوت تناهيـد ( @Ncoe_bot ) .. تلقـائيـاً ✓**\n\n\n⪼ `.المليار ايقاف`\n**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت المليـار ..**\n\n⪼ `.الجوكر ايقاف`\n**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت الجوكـر ..**\n\n⪼ `.الجنرال ايقاف`\n**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت الجنــرال ..**\n\n⪼ `.المليون ايقاف`\n**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت المليــون ..**\n\n⪼ `.سمسم ايقاف`\n**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت سمـسـم ..**\n\n⪼ `.تناهيد ايقاف`\n**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت تناهيـد ..**\n\n\n**「❖╎قـائمـة اوامـر تجميـع نقـاط العـاب بـوت وعــد🦾 :** \n\n`.بخشيش وعد` | `.ايقاف بخشيش وعد\n`.راتب وعد` | `.ايقاف راتب وعد`\n`.استثمار وعد` | `.ايقاف استثمار وعد`\n`.سرقة وعد` | `.ايقاف سرقة وعد`\n**(الامـر + ايـدي الشخـص)**\n`.كلمات وعد`\n**(الامـر + عـدد الاعـادة للامـر)**\n**⪼ لـ تجميـع نقـاط لعبـة البنـك وغيرهـا في بوت وعـد او اي بوت تلقائيـاً ✓ **"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir18")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**「❖╎قـائمـة اوامـر الاشتـراك الاجبـاري الخاص بسـورس يـــمنثون 🦾 :**\n\n**- اولاً اوامـر اضافـة القنـاة المطلوبـه للفـارات :**\n\n⪼ `.ضع اشتراك الخاص` | `.وضع اشتراك الخاص`\n**⪼ لـ اضافة قناة اشتراك الخاص للفارات .. استخدم الامر + معرف القناة او الامـر فقـط داخل القناة ✓**\n\n⪼ `.ضع اشتراك الكروب` | `.وضع اشتراك الكروب`\n**⪼ لـ اضافة قناة اشتراك الكروب للفارات .. استخدم الامـر + معرف القناة داخل الكروب ✓**\n\n\n**- ثانيـاً اوامـر تفعيـل الاشتـراك بعـد اضافة القنـاة :**\n\n⪼`.تفعيل اشتراك الخاص`\n**⪼ لـ تفعيـل الاشتـراك الاجبـاري للخـاص بعـد اضافة القنـاة ✓**\n\n**⪼ لـ تفعيـل الاشتـراك الاجبـاري للكروب مايحتاج امـر .. اول ماتضيف القناة يتفعل الاشتراك تلقائي ✓**\n\n\n**- ثالثـاً اوامـر تعطيـل الاشتــراك :**\n\n⪼ `.تعطيل اشتراك الخاص`\n**⪼ لـ تعطيـل الاشتـراك الاجبـاري للخـاص اذا كـان مفعـل ✓**\n\n⪼ `.تعطيل اشتراك الكروب`\n**⪼ لـ تعطيـل الاشتـراك الاجبـاري للكـروب اذا كـان مفعـل ✓**"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir19")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافة والتفليــش](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**「❖╎قـائمـة اوامـر اضـافة الاعضـاء وتفليـش الكروبـات الخاص بسـورس يـــمنثون 🦾 :** \n\n**- اولاً اوامــر اضـافة الاعضـاء كالتالـي :**\n\n⪼ `.ضيف`\n**⪼ .ضيف + رابط المجموعـه لـ اضـافة الاعضـاء استخـدم الامـر بالمجمـوعـة الهـدف مع اضافه رابط كروبك لـ الامـر ✓**\n\n\n**- ثانيـاً اوامــر تفليــش الكروبـات كالتالـي :**\n\n⪼ `.تفليش`\n**⪼ لـ تفليـش جميـع اعضـاء مجمـوعـه معينـه .. استخـدم الامـر داخـل المجمـوعـة + تحتـاج رتبـة مشـرف بالمجمـوعـة ✓**\n\n⪼`.تفليش بالطرد`\n**لـ تفليـش جميـع اعضـاء مجمـوعـه معينـه بالطـرد فقـط وليس بالحظـر .. استخـدم الامـر داخـل المجمـوعـة + تحتـاج رتبـة مشـرف بالمجمـوعـة ✓**\n\n⪼ `.حظر_الكل`\n**⪼ حظـر وتفليـش اعضـاء الكروب عبر بوت الحماية المرفوع بالكروب + ماتحتاج اشراف انت فقط تحتاج رتبه ادمن ومافوق بالبوت ✓**\n\n⪼ `.طرد_الكل`\n**⪼ طـرد وتفليـش اعضـاء الكروب عبر بوت الحماية المرفوع بالكروب + ماتحتاج اشراف انت فقط تحتاج رتبه ادمن ومافوق بالبوت ✓**\n\n⪼ `.كتم_الكل`\n**⪼ كتـم اعضـاء الكروب عبر بوت الحماية المرفوع بالكروب + ماتحتاج اشراف انت فقط تحتاج رتبه ادمن ومافوق بالبوت ✓**\n\n⪼ `.الغاء التفليش`\n**⪼ لـ الغـاء عمليـة التفليـش او الكتـم الجاريـه وايقافهـا ✓**"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"baqir20")))
@check_owner
async def rep_handler(zedub):
    text = "[ᯓ 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - (اوامــر النشــر العـام (السـوبــرات 🎡](t.me/YamenThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**「❖╎قـائمـة اوامـر السـوبـر (النشـر العـام) الخاصـه بـ سـورس يـــمنثون ♾ :**\n\n`.سوبر`\n**⪼ الامـر + عـدد الثـوانـي + عـدد مـرات التكـرار (بالـرد ع رسـالة او ميديـا)**\n**⪼ لـ النشـر التكـراري العـام بكـل مجموعـات قائمـة السـوبـر ( خـاص بجماعـة بالسـوبـرات ) ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n`.ايقاف سوبر`\n**⪼ استخـدم الامـر داخـل المجموعـة المحـدده ...**\n**⪼ لـ إيقـاف النشـر العـام عـن مجموعـة معينـه ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n`.ايقاف السوبرات`\n**⪼ لـ إيقـاف النشـر التكـراري العـام عـن جميـع المجموعـات ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n`.اضف سوبر`\n**⪼ استخـدم الامـر داخـل المجموعـة المحـدده ...**\n**⪼ لـ اضافة مجموعـة محـددة لـ قائمـة مجموعـات السوبـر ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n`.حذف سوبر`\n**⪼ استخـدم الامـر داخـل المجموعـة المحـدده ...**\n**⪼ لـ حـذف مجموعـة محـددة مـن قائمـة مجموعـات السوبـر ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n`.السوبرات`\n**⪼ لـ جلب قائمـة مجموعـات السوبـر الخاصـه بك ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n`.حذف السوبرات`\n**⪼ لـ حـذف وتصفيـر قائمـة مجموعـات السوبـر الخاصـه بك ...✓**\n\nٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄\n\n**⪼ مـلاحظــات هـامــه :**\n- اوامـر السوبـرات إضـافة جديـدة خاصـه وحصريـه بسـورس يـــمنثون¹ فقـط ...\n- تحديثات السوبـر متواصـلة لـ إضـافة كـل ماهـو جديـد بالتحديثـات الجايـه ...\n- نسعـى جاهـدين لـ جعـل اوامـر السوبـر سهـله وسلسـه لـكي توفـر لكـم الجهـد والتعب ...\n- شكـر خـاص لـ منصبيـن السـورس علـى افكـارهم الرائعـه والمفيـده ...\n\n𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/YamenThon) 𓆪"
    roger = [[Button.inline("رجــوع", data="bbaqir")]]
    await event.edit(text, buttons=roger, link_preview=False)
...
async def rep_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("يـــمنثون") and event.query.user_id == zedub.uid:
        RPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/YamenThon"),],[Button.url("التحـديثـات", "https://t.me/YamenThon1"), Button.url("الفـارات", "https://t.me/YamenThon_vars"),],[Button.url("الشـروحـات", "https://t.me/YamenThon1"),],[Button.url("مطـور السـورس", "https://t.me/T_A_Tl"),]]
        if RPIC and RPIC.endswith((".jpg", ".png", "gif", "mp4")):
            ...
            result = builder.document(RPIC,title="zedub",text=Channels,buttons=buttons,link_preview=True)
        else:
            result = builder.article(title="zedub",text=Channels,buttons=buttons,link_preview=True)
        await event.answer([result] if result else None)
@zedub.zed_cmd(pattern="يـــمنثون")
async def reporepthon(event):
    if event.fwd_from:
        return
    TG_BOT = Config.TG_BOT_USERNAME
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(TG_BOT, "يـــمنثون")
    await response[0].click(event.chat_id)
    await event.delete()
...
async def rep_handler(event):
    ...
    if query.startswith("السورس") and event.query.user_id == zedub.uid:
        RPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("قنـاة الســورس", "https://t.me/YamenThon")]]
        if RPIC and RPIC.endswith((".jpg", ".png")):
            result = builder.photo(RPIC,text=Baqir, buttons=buttons, link_preview=True)
        elif RPIC and RPIC.endswith((".gif", ".mp4")):
            result = builder.document(RPIC,title="zedub",text=Baqir,buttons=buttons,link_preview=True)
        else:
            result = builder.article(title="zedub",text=Baqir,buttons=buttons,link_preview=True)
        await event.answer([result] if result else None)
...
async def rep_handler(event):
    ...
    if query.startswith("اليدوي") and event.query.user_id == zedub.uid:
        ...
        result = builder.article(title="zedub",text=baqir,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
...
async def rep_handler(event):
    ...
    if query.startswith("الهيروكو") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضـغـط هنــا", "https://t.me/YamenThonn/28")]]
