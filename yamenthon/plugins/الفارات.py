...
ZelzalVP_cmd = (
    "𓆩 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗩𝗮𝗿𝘀 **🝢 اوامـر الفـارات** 𓆪\n"
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
    ...
    "⪼ `.اضف كليشة البلوك` بالـرد ع الكليشـة لتغييـر كليشة الحظر خاص\n"
    ...
    "⪼ `.اضف زر الستارت` بالـرد ع يوزرك او يوزر قناتك لـ اضـافة زر الستـارت\n\n"
    ...
    "⪼ `.اضف نقطة المطور` بالـرد ع الـرمز الجديـد\n\n"
    "⪼ `.اضف تيرمكس` بالـرد ع الكـود الجديـد\n\n"
    "⪼ `.اضف توكن البوت` بالـرد ع التوكن الجديـد\n\n"
    "⪼ `.اضف كود تيرمكس` بالـرد ع الكـود الجديـد\n\n"
    "⪼ `.اضف توكن البوت` بالـرد ع التوكن الجديـد\n\n"
    "⪼ `.اضف مساعد الميوزك` بالـرد ع كـود تيليثون حساب مساعد الميوزك الجديـد\n\n"
    "⪼ `.اضف فار نوم الترحيب` بالـرد ع رقـم الساعة لبداية نوم الترحيب المؤقت\n\n"
    "⪼ `.اضف ثواني لانهائي` بالـرد ع رقـم لعـدد الثوانـي الفاصـله بيـن كل عمليـة تجميـع فـي الامـر لانهائـي\n\n"
...
async def variable(event):
    ...
    # All Rights Reserved for "YamenThon - asheq lasamt"
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("**✧ تم تغييـر {} بنجـاح ☑️**\n**✧ المتغيـر : ↶**\n `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("**✧ تم اضافـة {} بنجـاح ☑️** \n**✧ المضاف اليه :**\n `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        ...
        await asyncio.sleep(1.5)
        if "=" not in vinfo:
            return await zed.edit("**✧ خطـأ .. قم بالـرد ع كود تيليثون - Telethon فقـط ؟!**")
        if variable in heroku_var:
            await zed.edit("**✧ تم تغييـر {} بنجـاح ☑️**\n**✧ المتغيـر : ↶**\n `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("**✧ تم اضافـة {} بنجـاح ☑️** \n**✧ المضاف اليه :**\n `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("**✧ تم حـذف {} بنجـاح ☑️**\n**✧ المتغيـر المحـذوف : ↶**\n `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, variable))
        ...
        if variable not in heroku_var:
        	return await zed.edit("**✧ عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("**✧ تم حـذف {} بنجـاح ☑️**\n**✧ المتغيـر المحـذوف : ↶**\n `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, heroku_var[variable]))
        ...
        if variable not in heroku_var:
        	return await zed.edit("**✧ عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("**✧ تم حـذف الفـار .. بنجـاح ☑️**\n**✧ المتغيـر المحـذوف : ↶** `{}` \n**✧ يتم الان اعـادة تشغيـل بـوت يمنثون  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str))
        del heroku_var[variable]
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**✧ الفـار {} موجـود ☑️**\n**✧ قيمـة الفـار : ↶**\n `{}` \n\n**✧ قنـاة السـورس : @YamenThon**".format(input_str, variable))
        ...
        variable = "STRING_SESSION"
        if variable not in heroku_var:
            await zed.edit("**✧ فـار {} غيـر موجـود ❌**\n**✧ لـ اضـافته بالـرد ع الاسم استخـدم الامـر : ↶**\n `.اضف {}` \n\n**✧ قنـاة السـورس : @YamenThon**".format(input_str, input_str))
        else:
            await zed.edit("**✧ الفـار {} موجـود ☑️**\n**✧ قيمـة الفـار : ↶**\n `{}` \n\n**✧ قنـاة السـورس : @YamenThon**".format(input_str, variable))
        ...
        if variable is None:
            await zed.edit("**✧ فـار ايموجي/رمز الايدي غيـر موجـود ❌**\n**✧ لـ اضـافته بالـرد ع الكليشـة من هنا ( @YamenThon_cklaish ) استخـدم الامـر : ↶**\n `.اضف كليشة الايدي` \n\n**✧ قنـاة السـورس : @YamenThon**")
        else:
            await zed.edit("**✧ الفـار {} موجـود ☑️**\n**✧ قيمـة الفـار : ↶**\n `{}` \n\n**✧ قنـاة السـورس : @YamenThon**".format(input_str, variable))
...
async def variable(event):
    ...
    zed = await edit_or_reply(event, "**✧ جـاري أعـداد المنطقـه الزمنيـه لـ يمنثـون 🌐...**")
    # All Rights Reserved for "YamenThon - asheq lasamt"
