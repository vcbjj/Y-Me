    ...
    try:
        await event.edit(
            ...
            buttons=[
                ...
                [
                    Button.inline("الحــذف و التنظيف 🗑️", data="yamclen"),
                    
                    Button.inline("جـوجــل 𝒢𝑜𝑜𝑔𝓁𝑒 🌍", data="yamgoogle"),
                ],
                [Button.inline("ᯓ★ رجـــوع", data="ZEDHELP")],
            ],
        link_preview=False)
    except Exception:
        await event.answer(zelzal, cache_time=0, alert=True)
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"yamclen")))
@check_owner
async def _(event):
    await event.edit(
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"yamgoogle")))
@check_owner
async def _(event):
    await event.edit(
