...
ZelzalNSH_cmd = (
    "𓆩 [ اوامـر النشـر التلقـائي](t.me/YamenThon) 𓆪\n\n"
...
async def _(event):
    if (event.is_private or event.is_group):
        return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎عـذراً .. النشر التلقائي خـاص بالقنـوات فقـط\n    ⃟⁞⃟⟢ ╎قم باستخـدام الامـر داخـل القنـاة الهـدف**")
    if input_str := event.pattern_match.group(2):
        try:
            zch = await event.client.get_entity(input_str)
        except Exception as e:
            return await edit_delete(event, "**    ⃟⁞⃟⟢ ╎عـذراً .. معـرف/ايـدي القنـاة غيـر صـالح**\n**    ⃟⁞⃟⟢ ╎الرجـاء التـأكـد مـن المعـرف/الايـدي**", 5)
        try:
            if is_post(zch.id , event.chat_id):
                return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎النشـر التلقـائي مفعـل مسبقـاً ✓**")
            if zch.first_name:
                await asyncio.sleep(1.5)
                add_post(zch.id, event.chat_id)
                await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎تم تفعيـل النشـر التلقـائي من القنـاة .. بنجـاح ✓**")
        except Exception:
            try:
                if is_post(zch.id , event.chat_id):
                    return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎النشـر التلقـائي مفعـل مسبقـاً ✓**")
                if zch.title:
                    await asyncio.sleep(1.5)
                    add_post(zch.id, event.chat_id)
                    return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎تم تفعيـل النشـر التلقـائي من القنـاة .. بنجـاح ✓**")
            except Exception as e:
                LOGS.info(str(e))
        await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎عـذراً .. معـرف/ايـدي القنـاة غيـر صـالح**\n**    ⃟⁞⃟⟢ ╎الرجـاء التـأكـد مـن المعـرف/الايـدي**")
    ...
    if input_str := event.pattern_match.group(2):
        ...
        try:
            if not is_post(zch.id, event.chat_id):
                return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎عـذراً .. النشـر التلقـائي غير مفعـل من اساسـاً ؟!**")
            if zch.first_name:
                await asyncio.sleep(1.5)
                remove_post(zch.id, event.chat_id)
                await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎تم تعطيـل النشر التلقـائي هنـا .. بنجـاح ✓**")
        except Exception:
            try:
                if not is_post(zch.id, event.chat_id):
                    return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎عـذراً .. النشـر التلقـائي غير مفعـل من اساسـاً ؟!**")
                if zch.title:
                    await asyncio.sleep(1.5)
                    remove_post(zch.id, event.chat_id)
                    return await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎تم تعطيـل النشر التلقـائي هنـا .. بنجـاح ✓**")
            except Exception as e:
                LOGS.info(str(e))
        await edit_or_reply(event, "**    ⃟⁞⃟⟢ ╎عـذراً .. معـرف/ايـدي القنـاة غيـر صـالح**\n**    ⃟⁞⃟⟢ ╎الرجـاء التـأكـد مـن المعـرف/الايـدي**")
