...
"**طبعا اي محادثه تريد ان يتم تفعيل فيها الترجمة التلقائـيه قم بارسال الامر داخل المحادثه لكي تنضاف في قائمة الترجمة التلقائـيه**\n\n"
"⚉ .لغه الترجمه`\n"
"**⪼ هاذا الامر يمكنك من تعيين لغه الترجمه للمحادثه مثال ↶** `.لغه الترجمه انجليزي`\n"
...
@zedub.zed_cmd(pattern="اللغات المدعومه")
async def cmd(asheqqqq):
    await edit_or_reply(asheqqqq, Asheqlan_cmd)            
