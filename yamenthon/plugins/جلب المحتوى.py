...
"**يحفظ الصور و الفديوهات و الملفات من القنوات ذات تقييد المحتوى ويرسلها إلى الرسائل المحفوظة**\n\n"
"⚉ .الغاء الحفظ`\n"
"**⪼ إلغاء عملية حفظ الميديا **\n"
"**يقول بإلغاء العملية الجارية لحفظ الميديا من القنوات ذات تقييد المحتوى**\n\n"
