...
BaqirDV_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 - اوامــر المطـور المســاعد](t.me/YamenThon) .\n\n"
...
async def add_sudo_user(event):
    ...
    output += "**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
