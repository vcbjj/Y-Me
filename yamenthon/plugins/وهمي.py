...
async def _(event):
    ...
    if response_api["cod"] == 200:
        ...
        await edit_or_reply(
            event,
            """ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 **- حـالة الطقـس** 🌐
**•─────────────────•**
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع الكتابه الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال تسجيل الصوت الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال الفيديو الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع اللعب الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال صوره وهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال الموقع الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال الجهات الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال الملف الوهمي لـ {t} من الثوانـي ✓**")
...
async def _(event):
    ...
    await event.edit(f"**   ⃟⁞⃟⟢╎تم بدء وضع ارسال البصمه المرئيه الوهمي لـ {t} من الثوانـي ✓**")
    async with event.client.action(event.chat_id, "round"):
        await asyncio.sleep(t)

@zedub.zed_cmd(pattern="ايقاف الوهمي(?: |$)(.*)")
async def _(event):
    await event.edit("**   ⃟⁞⃟⟢╎تم ايقـاف الارسـال الوهمـي .. بنجـاح ✓**")
